...
export default {
  validate ({ params, store }) {
    return sourceFileArray.includes(`contents/services/${params.slug}.${params.locale}.md`);
  },
  asyncData ({ params, store}) {
    return Object.assign({}, require(`~/contents/json/services/${params.slug}.${params.locale}.json`), { params });
  },
  // head() {
